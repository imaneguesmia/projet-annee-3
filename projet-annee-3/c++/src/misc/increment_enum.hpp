 ...
 *                      `EnumType::LAST` to be used as the maximum value, and `EnumType::OOB` to indicate overflow.
 ...
 *                      `EnumType::FIRST` to be used as the minimum value, and `EnumType::OOB` to indicate underflow.
